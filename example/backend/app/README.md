...
- `MONGO_DATABASE_URI` has been set in `example/.env`; leaving the initial value as `mongodb` will establish a connection to the docker instance of mongo created.
